...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-yw3wswy.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-yw3wswy.containers.anotherwebservice.com/
...
```
git clone git@github.com:chrisjsimpson/container-yw3wswy.git
cd container-yw3wswy
```
...
```
docker attach container-yw3wswy
```
